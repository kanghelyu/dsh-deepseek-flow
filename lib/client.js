/* deepseek-flow client-rev:37e746a0cf34 */
...
function GraphCanvas({
  ...
  for (const edge of edges) {
    ...
    const displayLabel = edge.autoLogicLabel ? branchDisplayLabel(gateBranchForEdge(edge), language) : edge.label;
    edgeElements.push(
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      nodes.map((node) => import_react.default.createElement(
        ...
        import_react.default.createElement(FlowNode, { data: node.data, selected: selectedNode === node.id, language }),
...
function logicSnapshot(flow) {
  return JSON.stringify({
    ...
    nodes: (flow?.nodes ?? []).map((node) => ({
      ...
      content: node.kind === "agent" || node.kind === "mapAgent" ? String(node.data?.prompt ?? "") : String(node.data?.instructions ?? "")
    })),
...
function Studio({ connection, sessionId, language }) {
  const t = (0, import_react.useMemo)(() => text(language), [language]);
  ...
  const [activeDoc, setActiveDoc] = (0, import_react.useState)("workflow");
  const [documentsOpen, setDocumentsOpen] = (0, import_react.useState)(() => storedBoolean("deepseek-flow:left-open", window.innerWidth > 1040));
  const [inspectorOpen, setInspectorOpen] = (0, import_react.useState)(() => storedBoolean("deepseek-flow:right-open", window.innerWidth > 1040));
  const [documentWidth, setDocumentWidth] = (0, import_react.useState)(() => storedNumber("deepseek-flow:left-width", LEFT_PANEL_DEFAULT));
  const [inspectorWidth, setInspectorWidth] = (0, import_react.useState)(() => storedNumber("deepseek-flow:right-width", RIGHT_PANEL_DEFAULT));
  const [studioWidth, setStudioWidth] = (0, import_react.useState)(() => Math.max(640, Number(window.innerWidth) || 1200));
  const [message, setMessage] = (0, import_react.useState)(t.ready);
  const [dirty, setDirty] = (0, import_react.useState)(false);
  const [flowInstance, setFlowInstance] = (0, import_react.useState)(null);
  const [gatePickerOpen, setGatePickerOpen] = (0, import_react.useState)(false);
  const [pendingConnection, setPendingConnection] = (0, import_react.useState)(null);
  const [connectionWarning, setConnectionWarning] = (0, import_react.useState)(null);
  const [assistantOpen, setAssistantOpen] = (0, import_react.useState)(() => storedBoolean("deepseek-flow:assistant-open", false));
  const [assistantHeight, setAssistantHeight] = (0, import_react.useState)(() => storedNumber("deepseek-flow:assistant-height", ASSISTANT_DEFAULT));
  const [assistantBusy, setAssistantBusy] = (0, import_react.useState)(null);
  const [runningDocs, setRunningDocs] = (0, import_react.useState)(() => /* @__PURE__ */ new Map());
  const [assistModel, setAssistModel] = (0, import_react.useState)("");
  const [assistEffort, setAssistEffort] = (0, import_react.useState)("");
  const [assistMenuOpen, setAssistMenuOpen] = (0, import_react.useState)(false);
  const [assistMenuPage, setAssistMenuPage] = (0, import_react.useState)(null);
  const [assistModelOptions, setAssistModelOptions] = (0, import_react.useState)(null);
  const [assistantInstruction, setAssistantInstruction] = (0, import_react.useState)("");
  const [validationResult, setValidationResult] = (0, import_react.useState)(null);
  const [findingFilter, setFindingFilter] = (0, import_react.useState)(null);
  const [optimizationProposal, setOptimizationProposal] = (0, import_react.useState)(null);
  const [assistantDraft, setAssistantDraft] = (0, import_react.useState)("");
  const proposalStoreRef = import_react.default.useRef(/* @__PURE__ */ new Map());
  const pollTimerRef = import_react.default.useRef(null);
  const [workflowOptimizeConfirm, setWorkflowOptimizeConfirm] = (0, import_react.useState)(false);
  const fileRef = import_react.default.useRef(null);
  const documentTimerRef = import_react.default.useRef(null);
  const fitTimerRef = import_react.default.useRef(null);
  const documentWriteChainRef = import_react.default.useRef(Promise.resolve());
  const documentRevisionRef = import_react.default.useRef(0);
  const optimizationRequestRef = import_react.default.useRef(0);
  const activeAssistRef = import_react.default.useRef(null);
  const currentIdRef = import_react.default.useRef(null);
  const nodesRef = import_react.default.useRef([]);
  const edgesRef = import_react.default.useRef([]);
  const historyRef = import_react.default.useRef({ past: [], future: [] });
  const studioRef = import_react.default.useRef(null);
  const canvasShellRef = import_react.default.useRef(null);
  const panelDragRef = import_react.default.useRef(null);
  const assistantDragRef = import_react.default.useRef(null);
  const fitWholeFlow = (0, import_react.useCallback)((duration = 260) => {
    flowInstance?.fitView?.({ padding: 0.18, minZoom: GRAPH_MIN_ZOOM, maxZoom: 1.15, duration });
  }, [flowInstance]);
  const beginPanelResize = (0, import_react.useCallback)((side, event) => {
  ...
  const panelKeyDown = (0, import_react.useCallback)((side, event) => {
    const isLeft = side === "left";
  ...
  const beginAssistantResize = (0, import_react.useCallback)((event) => {
    if (event.button !== void 0 && event.button !== 0) return;
    event.preventDefault();
  ...
  const showFlow = (0, import_react.useCallback)((flow, options = {}) => {
    if (!flow) return;
  ...
  const loadFlows = (0, import_react.useCallback)(async () => {
    try {
  ...
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:left-open", documentsOpen), [documentsOpen]);
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:right-open", inspectorOpen), [inspectorOpen]);
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:left-width", Math.round(documentWidth)), [documentWidth]);
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:right-width", Math.round(inspectorWidth)), [inspectorWidth]);
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:assistant-open", assistantOpen), [assistantOpen]);
  (0, import_react.useEffect)(() => keepLayout("deepseek-flow:assistant-height", Math.round(assistantHeight)), [assistantHeight]);
  (0, import_react.useEffect)(() => () => {
  ...
  const scheduleDocumentSave = (0, import_react.useCallback)((flowSnapshot, nodeSnapshot, edgeSnapshot) => {
    ...
    documentTimerRef.current = setTimeout(() => {
      ...
      documentWriteChainRef.current = documentWriteChainRef.current.catch(() => {
      }).then(async () => {
        try {
  ...
  const rememberGraph = (0, import_react.useCallback)(() => {
  ...
  const restoreGraph = (0, import_react.useCallback)((snapshot) => {
  ...
  const undoGraph = (0, import_react.useCallback)(() => {
    const history = historyRef.current;
  ...
  const redoGraph = (0, import_react.useCallback)(() => {
    const history = historyRef.current;
  ...
  const showConnectionWarning = (0, import_react.useCallback)((problem) => {
  ...
  const commitConnection = (0, import_react.useCallback)((conn, requestedBranch = null) => {
  ...
  const onConnect = (0, import_react.useCallback)((conn) => {
  ...
  const onConnectionRejected = (0, import_react.useCallback)((conn) => {
    showConnectionWarning(connectionProblem(nodesRef.current, edgesRef.current, conn));
  }, [showConnectionWarning]);
  const onReconnect = (0, import_react.useCallback)((oldEdge, connectionParams) => {
    rememberGraph();
  ...
  const isValidConnection = (0, import_react.useCallback)((connectionParams) => {
    return connectionProblem(nodesRef.current, edgesRef.current, connectionParams).valid;
  }, []);
  const moveNode = (0, import_react.useCallback)((id, position) => {
  ...
  const removeSelectedEdge = (0, import_react.useCallback)(() => {
  ...
  const tidyGraph = (0, import_react.useCallback)(() => {
  ...
  const assistantTargetRef = import_react.default.useRef(assistantTarget);
  (0, import_react.useEffect)(() => {
  ...
  const runLogicValidation = async () => {
    ...
    try {
      ...
      pollTimerRef.current = pollAssist(requestId, (entry) => {
        if (entry.status === "done" && entry.result) {
          setValidationResult({ ...entry.result, snapshot: logicSnapshot(flow), checkedAt: (/* @__PURE__ */ new Date()).toISOString() });
          setFindingFilter(null);
          setMessage(t.validationComplete);
        } else {
  ...
  const addBar = import_react.default.createElement(
    "div",
    { className: "df-addbar" },
    import_react.default.createElement("span", { className: "df-node__kind", style: { alignSelf: "center", color: "var(--df-ink-2)" } }, t.addNode),
    ["input", "agent", "mapAgent", "condition", "merge", "output"].map(
      (kind) => import_react.default.createElement("button", { key: kind, className: "df-btn", onClick: () => addNode(kind) }, t.nodeKind[kind])
    ),
    import_react.default.createElement("span", { className: "df-connect-hint" }, t.connectHint)
  );
  const toolbar = import_react.default.createElement(
    "div",
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        flows.map((f) => import_react.default.createElement("option", { key: f.id, value: f.id }, `${f.name}${f.sessionId ? "" : ` (${t.shared})`}`))
      )
    ),
    import_react.default.createElement("button", { className: "df-btn is-ghost", onClick: () => fileRef.current?.click() }, t.importLabel),
    import_react.default.createElement("input", { ref: fileRef, type: "file", accept: ".json,application/json", className: "df-import-hidden", onChange: onImportFile }),
    import_react.default.createElement("button", { className: "df-btn is-ghost", onClick: exportJson, disabled: currentId === null }, t.exportLabel),
    import_react.default.createElement("button", { className: "df-btn", onClick: save, disabled: currentId === null || !dirty }, t.save),
    import_react.default.createElement("button", { className: "df-btn df-iconbtn is-ghost", title: `${t.undo} \xB7 Ctrl/Cmd+Z`, "aria-label": t.undo, onClick: undoGraph }, "\u21B6"),
    import_react.default.createElement("button", { className: "df-btn df-iconbtn is-ghost", title: `${t.redo} \xB7 Ctrl/Cmd+Shift+Z`, "aria-label": t.redo, onClick: redoGraph }, "\u21B7"),
    import_react.default.createElement("button", { className: "df-btn is-ghost", title: t.tidy, onClick: tidyGraph, disabled: nodes.length === 0 }, t.tidy),
    import_react.default.createElement("button", { className: "df-btn is-ghost", title: t.fitAll, onClick: () => fitWholeFlow(240), disabled: nodes.length === 0 }, t.fitAll),
    import_react.default.createElement("span", { className: "df-status" }, message)
  );
  ...
  const documentRail = import_react.default.createElement(
    "aside",
    { className: `df-docrail${documentsOpen ? "" : " is-collapsed"}` },
    import_react.default.createElement(
      "div",
      { className: "df-docrail__head" },
      import_react.default.createElement("div", { className: "df-docrail__title" }, t.documents),
      import_react.default.createElement("div", { className: "df-docrail__note" }, t.documentFirstNote)
    ),
    documentsOpen && import_react.default.createElement(
      "div",
      { className: "df-docrail__list" },
      import_react.default.createElement("div", { className: "df-docgroup" }, t.workflowDoc),
      import_react.default.createElement(
        "button",
        {
        ...
        import_react.default.createElement("span", { className: "df-docitem__icon" }, "MD"),
        import_react.default.createElement(
          "span",
          null,
          import_react.default.createElement("span", { className: "df-docitem__label" }, currentFlow?.workflowDoc ?? "WORKFLOW.md"),
          import_react.default.createElement("span", { className: "df-docitem__path" }, currentFlow?.docRoot ?? t.none)
        )
      ),
      import_react.default.createElement("div", { className: "df-docgroup" }, t.stepDocs),
      nodes.map((node, index) => import_react.default.createElement(
        "button",
        {
          key: node.id,
        ...
        import_react.default.createElement("span", { className: "df-docitem__icon" }, String(index + 1).padStart(2, "0")),
        import_react.default.createElement(
          "span",
          null,
          import_react.default.createElement("span", { className: "df-docitem__label" }, String(node.data.label ?? node.id)),
          import_react.default.createElement("span", { className: "df-docitem__path" }, currentFlow?.docs?.[node.id] ?? t.filePath)
        )
      ))
    )
  );
  const inspector = import_react.default.createElement(
    "aside",
    ...
    import_react.default.createElement(
      ...
      activeDoc === "workflow" && currentFlow ? [
        import_react.default.createElement("h3", { key: "title" }, currentFlow.workflowDoc ?? "WORKFLOW.md"),
        import_react.default.createElement("div", { key: "badge", className: "df-node__kind", style: { color: "var(--df-brand)" } }, t.documentFirst),
        import_react.default.createElement(
          "div",
          { key: "root", className: "df-pathbox" },
          import_react.default.createElement("span", { className: "df-pathbox__label" }, t.docRoot),
          import_react.default.createElement("span", { className: "df-pathbox__value" }, currentFlow.docRoot ?? t.none)
        ),
        import_react.default.createElement(
          "label",
          { key: "content" },
        ...
        import_react.default.createElement("h3", { key: "title" }, String(selectedNode.data.label ?? selectedNode.id)),
        import_react.default.createElement(
          "div",
          { key: "path", className: "df-pathbox" },
          import_react.default.createElement("span", { className: "df-pathbox__label" }, t.filePath),
          import_react.default.createElement("span", { className: "df-pathbox__value" }, currentFlow?.docs?.[selected] ?? t.none)
        ),
        import_react.default.createElement(
          "label",
          { key: "markdown" },
        ...
        import_react.default.createElement("h3", { key: "properties", style: { marginTop: 4 } }, t.properties),
        import_react.default.createElement(
          "label",
          { key: "kind" },
          "kind",
          import_react.default.createElement("span", { style: { color: "var(--df-ink-2)", fontSize: 12 } }, t.nodeKind[selectedNode.data.kind] ?? selectedNode.data.kind)
        ),
        import_react.default.createElement(
          "label",
          { key: "label" },
          "label",
          import_react.default.createElement("input", { value: String(selectedNode.data.label ?? ""), onChange: (e) => patchSelected({ label: e.target.value }) })
        ),
        import_react.default.createElement(
          "label",
          { key: "doc" },
          t.docFile,
          import_react.default.createElement("input", { value: currentFlow?.docs?.[selected] ?? "", placeholder: "01-step/STEP.md", onChange: (e) => patchDoc(e.target.value) })
        ),
        selectedNode.data.kind === "condition" && import_react.default.createElement(
          "label",
          { key: "gateType" },
          t.gateTypeLabel,
          ...
          }, CONDITION_GATE_TYPES.map((gateType) => import_react.default.createElement("option", { key: gateType, value: gateType }, t.gateType[gateType])))
        ),
        selectedNode.data.kind === "condition" && import_react.default.createElement(
          "label",
          { key: "predicate" },
          ...
          import_react.default.createElement(
            ...
            ["truthy", "falsy", "nonEmpty"].map((p) => import_react.default.createElement("option", { key: p, value: p }, p))
          )
        ),
        (selectedNode.data.kind === "agent" || selectedNode.data.kind === "mapAgent") && import_react.default.createElement(
          "details",
          { key: "advanced", className: "df-advanced" },
          import_react.default.createElement("summary", null, t.advancedHints),
          import_react.default.createElement(
            "div",
            ...
            import_react.default.createElement(
              ...
              null,
              t.stage,
              import_react.default.createElement("input", { value: String(selectedNode.data.stage ?? ""), onChange: (e) => patchSelected({ stage: e.target.value }) })
            ),
            import_react.default.createElement(
              "label",
              null,
              t.provider,
              import_react.default.createElement("input", { value: String(selectedNode.data.provider ?? ""), onChange: (e) => patchSelected({ provider: e.target.value }) })
            ),
            import_react.default.createElement(
              "label",
              null,
              t.model,
              import_react.default.createElement("input", { value: String(selectedNode.data.model ?? ""), onChange: (e) => patchSelected({ model: e.target.value }) })
            ),
            import_react.default.createElement(
              "label",
              null,
              t.outputSchema,
              import_react.default.createElement("textarea", { value: selectedNode.data.outputSchema ? JSON.stringify(selectedNode.data.outputSchema) : "", onChange: (e) => {
        ...
        import_react.default.createElement("button", { key: "del", className: "df-btn", style: { color: "var(--df-err)" }, onClick: removeSelected }, t.deleteNode)
      ] : [
        import_react.default.createElement("h3", { key: "title" }, t.properties),
        import_react.default.createElement("div", { key: "empty", className: "df-empty" }, t.openDocument)
      ]
    )
  );
  ...
  const assistantPanel = import_react.default.createElement(
    "section",
    {
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("span", { className: "df-assistant__spark", "aria-hidden": true }, "\u2726"),
      import_react.default.createElement("span", { className: "df-assistant__title" }, t.assistant),
      import_react.default.createElement(
        "div",
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("span", { className: "df-assist-menu-caret", "aria-hidden": true }, "\u25BC")
        ),
        assistMenuOpen && import_react.default.createElement(
          "div",
          { className: "df-assist-menu" },
          assistMenuPage === null ? [
            import_react.default.createElement("button", { key: "m", type: "button", className: "df-assist-menu-item", onClick: () => setAssistMenuPage("model") }, t.assistModelLabel, "\uFF1A", assistModel || t.assistModelFollow),
            import_react.default.createElement("button", { key: "e", type: "button", className: "df-assist-menu-item", onClick: () => setAssistMenuPage("effort") }, t.assistEffortLabel, "\uFF1A", assistEffort === "off" ? t.assistEffortOff : assistEffort === "high" ? t.assistEffortHigh : assistEffort === "max" ? t.assistEffortMax : t.assistEffortFollow)
          ] : assistMenuPage === "model" ? [
            import_react.default.createElement("button", { key: "back", type: "button", className: "df-assist-menu-back", onClick: () => setAssistMenuPage(null) }, "\u2039 ", t.assistModelLabel),
            import_react.default.createElement("button", { key: "follow", type: "button", className: "df-assist-menu-item", onClick: () => {
              setAssistModel("");
              setAssistMenuOpen(false);
            } }, t.assistModelFollow),
            ...(assistModelOptions ?? []).map(
              (option) => import_react.default.createElement("button", {
            ...
            import_react.default.createElement("button", { key: "back", type: "button", className: "df-assist-menu-back", onClick: () => setAssistMenuPage(null) }, "\u2039 ", t.assistEffortLabel),
            [["", t.assistEffortFollow], ["off", t.assistEffortOff], ["high", t.assistEffortHigh], ["max", t.assistEffortMax]].map(
              ([value, label]) => import_react.default.createElement("button", {
                key: value,
                type: "button",
                className: "df-assist-menu-item",
                onClick: () => {
      ...
      import_react.default.createElement("span", { className: "df-assistant__target", title: `${t.assistantTarget}: ${assistantDocLabel}` }, assistantDocLabel),
      import_react.default.createElement(
        "div",
        { className: "df-assistant__actions" },
        import_react.default.createElement("button", { className: "df-btn is-primary", "data-df-action": "logic-validation", disabled: !currentFlow, onClick: runLogicValidation }, assistantBusy === "logic" ? t.agentLogicBusy : t.logicValidation),
        import_react.default.createElement("button", { className: "df-btn", "data-df-action": "optimize-document", disabled: !currentFlow, onClick: runDocumentOptimization }, runningDocs.get(assistantTarget) !== void 0 ? t.agentOptimizeBusy : t.aiOptimize),
        import_react.default.createElement("button", { className: "df-btn", "data-df-action": "optimize-workflow", disabled: !currentFlow, onClick: () => setWorkflowOptimizeConfirm(true) }, assistantBusy === "optimize-workflow" ? t.agentWorkflowBusy : t.aiOptimizeWorkflow),
        (assistantBusy || runningDocs.get(assistantTarget) !== void 0) && import_react.default.createElement("button", {
    ...
    assistantOpen && import_react.default.createElement(
      "div",
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          validationResult ? [
            import_react.default.createElement("span", { key: "total" }, `${validationResult.summary?.total ?? findings.length} ${t.issues}`),
            import_react.default.createElement("button", {
              key: "error",
              type: "button",
            ...
            validationStale && import_react.default.createElement("span", { key: "stale", className: "df-count is-warning" }, t.validationStale)
          ] : import_react.default.createElement("span", null, t.validationIdle)
        ),
        import_react.default.createElement(
          "div",
          { className: "df-findings" },
          validationResult && findings.length === 0 ? import_react.default.createElement("div", { className: "df-empty" }, t.noFindings) : visibleFindings.map((finding, index) => import_react.default.createElement(
            "button",
            {
            ...
            import_react.default.createElement("span", { className: "df-finding__dot" }),
            import_react.default.createElement(
              "span",
              null,
              import_react.default.createElement("span", { className: "df-finding__doc" }, findingDocumentLabel(finding)),
              import_react.default.createElement("span", { className: "df-finding__message" }, finding.message),
              finding.suggestion && import_react.default.createElement("span", { className: "df-finding__suggestion" }, finding.suggestion)
            )
          ))
        )
      ),
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement("span", { className: "df-assistant__preview-title" }, optimizationProposal ? `${t.proposalDecision} \xB7 ${optimizationProposal.documentLabel} \xB7 ${optimizationStale ? t.staleSuggestion : t.suggestionPreview}` : `${t.proposalDecision} \xB7 ${t.proposalPending}`),
          optimizationProposal && import_react.default.createElement(
            "span",
            null,
            import_react.default.createElement("button", { className: "df-btn is-ghost", "data-df-action": "discard-optimization", onClick: discardOptimization }, t.discardSuggestion),
            import_react.default.createElement("button", { className: "df-btn is-primary", "data-df-action": "accept-optimization", onClick: acceptOptimization, disabled: !assistantDraft || optimizationStale }, t.acceptSuggestion)
          )
        ),
        optimizationProposal ? import_react.default.createElement("textarea", { value: assistantDraft, onChange: (event) => setAssistantDraft(event.target.value), spellCheck: false }) : import_react.default.createElement(
          "div",
          { className: "df-assistant__pending" },
          import_react.default.createElement("span", null, `${t.proposalPending} \xB7 ${t.proposalIdle}`)
        )
      )
    )
  );
  const workflowConfirmDialog = workflowOptimizeConfirm && import_react.default.createElement(
    "div",
    {
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("h3", { id: "df-workflow-optimize-title" }, t.workflowOptimizeTitle),
      import_react.default.createElement("p", null, t.workflowOptimizeWarning),
      import_react.default.createElement(
        "div",
        { className: "df-confirm__actions" },
        import_react.default.createElement("button", { className: "df-btn", onClick: () => setWorkflowOptimizeConfirm(false) }, t.workflowOptimizeCancel),
        import_react.default.createElement("button", { className: "df-btn is-primary", "data-df-action": "confirm-optimize-workflow", onClick: runWorkflowOptimization }, t.workflowOptimizeConfirm)
      )
    )
  );
  const gatePickerDialog = gatePickerOpen && import_react.default.createElement(
    "div",
    {
      className: "df-confirm-backdrop",
      role: "presentation",
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("h3", { id: "df-gate-picker-title" }, t.chooseGateTitle),
      import_react.default.createElement("p", null, t.chooseGateIntro),
      import_react.default.createElement(
        "div",
        { className: "df-gate-grid" },
        CONDITION_GATE_TYPES.map((gateType) => import_react.default.createElement(
          "button",
          {
            key: gateType,
            type: "button",
          ...
          import_react.default.createElement("strong", null, t.gateType[gateType]),
          import_react.default.createElement("span", null, t.gateDescription[gateType])
        ))
      ),
      import_react.default.createElement(
        "div",
        { className: "df-confirm__actions" },
        import_react.default.createElement("button", { className: "df-btn", onClick: () => setGatePickerOpen(false) }, t.cancel)
      )
    )
  );
  const branchPickerDialog = pendingConnection && import_react.default.createElement(
    "div",
    {
      className: "df-confirm-backdrop",
      role: "presentation",
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("h3", { id: "df-branch-picker-title" }, t.chooseBranchTitle),
      import_react.default.createElement("p", null, t.chooseBranchIntro),
      import_react.default.createElement(
        "div",
        { className: "df-branch-options" },
        ["true", "false"].map((branch) => import_react.default.createElement("button", {
          key: branch,
          type: "button",
      ...
      import_react.default.createElement(
        "div",
        { className: "df-confirm__actions" },
        import_react.default.createElement("button", { className: "df-btn", onClick: () => setPendingConnection(null) }, t.cancel)
      )
    )
  );
  const connectionWarningDialog = connectionWarning && import_react.default.createElement(
    "div",
    {
      className: "df-confirm-backdrop",
      role: "presentation",
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement("h3", { id: "df-connection-warning-title" }, t.connectionWarningTitle),
      import_react.default.createElement("p", null, connectionWarning),
      import_react.default.createElement(
        "div",
        { className: "df-confirm__actions" },
        import_react.default.createElement("button", { className: "df-btn is-primary", onClick: () => setConnectionWarning(null) }, t.dismiss)
      )
    )
  );
  ...
  const leftSplitter = import_react.default.createElement("div", {
  ...
  const rightSplitter = import_react.default.createElement("div", {
  ...
  const assistantSplitter = import_react.default.createElement("div", {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      toolbar,
      import_react.default.createElement(GraphCanvas, {
        nodes,
        edges,
        language,
...
function DeepSeekFlowView({ connection, sessionId, language: initialLanguage, locale }) {
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      "nav",
      { className: "df-tabs" },
      import_react.default.createElement("span", { className: "df-titlebar__title" }, t.studio),
      import_react.default.createElement("span", { className: "df-titlebar__badge" }, t.editorOnly),
      import_react.default.createElement("span", { className: "df-titlebar__note" }, t.editorOnlyNote),
      import_react.default.createElement("span", { className: "df-titlebar__rev", title: `DeepSeekFlow client revision ${CLIENT_REV}` }, `rev ${CLIENT_REV}`)
    ),
    import_react.default.createElement(
      "main",
      { className: "df-main" },
      import_react.default.createElement(Studio, { connection, sessionId, language })
    )
  );
}
function apply(ctx) {
