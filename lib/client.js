/* deepseek-flow client-rev:28f1f3c04fea */
...
.df-inspector textarea.df-markdown-editor{min-height:300px;resize:none;background:var(--df-bg);border-radius:10px}
...
[data-conversation-scroll][data-deepseek-flow-immersive="true"]>:not([data-composer-seat]){flex:1 1 auto;min-height:0;height:100%}
...
function FlowNode({ data, selected }) {
  ...
  const children = [
    import_react.default.createElement("div", { className: "df-node__kind" }, text(browserLanguage()).nodeKind[kind] ?? kind),
  ...
  for (const edge of edges) {
    ...
    edgeElements.push(
      import_react.default.createElement(
        ...
        edge.label ? import_react.default.createElement(
          "g",
          ...
          import_react.default.createElement("text", { className: "df-graph__label", x: 0, y: 1 }, String(edge.label))
        ) : null
      )
    );
  }
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      nodes.map((node) => import_react.default.createElement(
        ...
        import_react.default.createElement(FlowNode, { data: node.data, selected: selectedNode === node.id }),
...
function Studio({ connection, sessionId, language }) {
  ...
  const onReconnect = (0, import_react.useCallback)((oldEdge, connectionParams) => {
    ...
    setEdges((items) => reconnectFlowEdge(oldEdge, connectionParams, items).map((edge) => edge.id === oldEdge.id ? {
      ...edge,
      label: connectionParams.sourceHandle === "true" ? language === "zh" ? "\u662F" : "Yes" : connectionParams.sourceHandle === "false" ? language === "zh" ? "\u5426" : "No" : void 0
    } : edge));
    ++documentRevisionRef.current;
    setDirty(true);
  ...
  const isValidConnection = (0, import_react.useCallback)((connectionParams) => {
    ...
    return !edgesRef.current.some((edge) => edge.source === connectionParams.source && edge.target === connectionParams.target);
  }, []);
