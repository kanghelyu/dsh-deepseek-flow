/* deepseek-flow client-rev:e3db959e2a0e */
    ...
    import_react2.default.createElement(
      ...
      import_react2.default.createElement(
        ...
        import_react2.default.createElement("button", {
          ...
          "aria-disabled": topologyDirty ? "true" : void 0,
          onClick: () => {
            if (topologyDirty) {
              setMessage(t.topologyPending);
              return;
        ...
        import_react2.default.createElement("button", { className: "df-btn", "data-df-action": "optimize-document", disabled: !currentFlow, onClick: runDocumentOptimization }, runningDocs.get(assistantTarget) !== void 0 ? t.agentOptimizeBusy : t.aiOptimize),
        import_react2.default.createElement("button", {
        ...
        (assistantBusy || runningDocs.get(assistantTarget) !== void 0) && import_react2.default.createElement("button", {
      ...
      import_react2.default.createElement(
        ...
        import_react2.default.createElement(
          ...
          validationResult ? [
            ...
            validationStale && import_react2.default.createElement("span", { key: "stale", className: "df-count is-warning" }, t.validationStale)
