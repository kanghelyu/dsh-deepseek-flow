/* deepseek-flow client-rev:66815ffdf704 */
...
function Studio({ connection, sessionId, language }) {
  ...
  const discardAndSwitchFlow = (0, import_react2.useCallback)(() => {
      ...
      import_react2.default.createElement(
        ...
        flows.length === 0 && import_react2.default.createElement(
          ...
          import_react2.default.createElement(
            ...
            import_react2.default.createElement("strong", null, t.noFlow),
            import_react2.default.createElement("span", null, t.emptyFlowHint)
          )
        ),
        topologyApplyButton
      ),
